...
namespace RSN.Project.BLL
{
    public class Student : Standard
    {
        ...
        public DataSet GetStudentDetails()
        {
            ...
            DataSet dataSet = SqlHelper.ExecuteDataSet(sqlCommandText, parameter, CommandType.StoredProcedure, Connection.GetConnection());
        ...
        public int InsertStudentDetails()
        {
            ...
            return SqlHelper.ExecuteNonQuery(sqlCommandText, CommandType.StoredProcedure, parameters, Connection.GetConnection());
        }
        ...
        public int DeleteStudentDetails()
        {
            ...
            return SqlHelper.ExecuteNonQuery(sqlCommandText, CommandType.StoredProcedure, parameter, Connection.GetConnection());
        }
